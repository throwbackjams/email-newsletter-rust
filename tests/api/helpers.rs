...
impl TestApp {
        ...
        Body: serde::Serialize,
    {
        self.api_client
            ...
            .form(body) // this method makes sure URL-encoded and Content-Type header is set
            .send()
            .await
    ...
    pub async fn get_change_password(&self) -> reqwest::Response {
        self.api_client
            ...
            .send()
            .await
            .expect("Failed to execute admin/password get request")
    }
            ...
            Body: serde::Serialize,
    {
        self.api_client
            ...
            .send()
            .await
            .expect("Failed to execute change password post request")
    }
...
pub async fn spawn_app() -> TestApp {
    // Ensure TRACING only executed once
    Lazy::force(&TRACING);

    // Launch a mock server to stand in for Postmark's API (email sending)
